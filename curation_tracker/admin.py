...
class LitsuggestPreviewForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['PMID', 'study_name', 'title', 'journal', 'eligibility', 'eligibility_dev_score',
                  'eligibility_eval_score', 'eligibility_description', 'curation_status',
                  'first_level_curation_status', 'year', 'publication_date']
...
class CurationPublicationAnnotationAdmin(MultiDBModelAdmin):
    ...
    list_display = (
        "id", "display_study_name", "display_PMID", "journal", "publication_date", "display_created_on",
        "display_pgp_id",
    ...
    list_filter = ("curation_status", "first_level_curator", "second_level_curator", "priority",
                   ("publication_date", PublicationDateFilter), "created_on")
    search_fields = ["id", "study_name", "pgp_id", "doi", "PMID", "first_level_curation_status",
                     "second_level_curation_status", "curation_status", "reported_trait", "title"]
    ordering = ('-id',)
    list_per_page = 25  # No of records per page

    fieldsets = (
        ('Publication', {
            'fields': ("id", "study_name", "created_on", "pgp_id", ("doi", "PMID"), ("journal", "year"), "title",
                       "publication_date", "release_date", "priority", "author_submission", "embargoed")
        }),
        ('Eligibility', {
            'fields': ("eligibility", ("eligibility_dev_score", "eligibility_eval_score"),
                       ("eligibility_external_valid", "eligibility_trait_matching"), "eligibility_score_provided",
                       "eligibility_description")
        }),
        ('Curation - First Level', {
            'fields': (
                "first_level_curator", ("first_level_curation_status", "first_level_date"), "first_level_comment")
        }),
        ('Curation - Second Level', {
            'fields': (
                "second_level_curator", ("second_level_curation_status", "second_level_date"), "second_level_comment")
        }),
