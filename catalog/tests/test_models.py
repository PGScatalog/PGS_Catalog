...
class DemographicTest(PGSTestCase):
...
class EFOTraitTest(PGSTestCase):
...
class PerformanceTest(PGSTestCase):
...
class PublicationTest(PGSTestCase):
...
class SampleSetTest(PGSTestCase):
...
class TraitCategoryTest(PGSTestCase):
...
class EFOTrait_OntologyTest(PGSTestCase):
...
class EmbargoedPublicationTest(PGSTestCase):
...
class EmbargoedScoreTest(PGSTestCase):
...
class EvaluatedScoreTest(PGSTestCase):
...
class RetiredScoreTest(PGSTestCase):
